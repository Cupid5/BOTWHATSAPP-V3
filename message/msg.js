  ...
  //=======================================================//
   ...
   //=======================================================//
    ...
    switch(order){
      ...
      let ana = await client.sendMessage(from, { text: 'satu' },{quoted:msg})      
      await ah.push(ana.key.id)
      let oek = await client.sendMessage(from, { text: 'dua' },{quoted:msg})
      await ah.push(oek.key.id)
      let ek = await client.sendMessage(from, { text: 'tiga' },{quoted:msg})
...
└──────────────☉`,
             ...
             let sourceUrl =  'https://instagram.com/zidnicupid_'
             let mediaUrl = 'https://instagram.com/zidnicupid_'                            
